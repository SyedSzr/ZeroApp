...
function AppProvider({ children }) {
  ...
  const translations = {
    ...
    fr: {
      ...
      hot_right_now: 'Populaire maintenant',
      top_pick_for_you: 'Meilleur choix pour vous',
      editors_picks: 'Sélection de l\'éditeur',
      popular_apps: 'Applications populaires',
      new_experience: 'Nouvelle expérience',
      super_apps: 'Super applications',
      apps_might_like: 'Applications que vous pourriez aimer',
      crowd_favorites: 'Favoris du public',
      this_month_best: 'Le meilleur de ce mois',
      recommended_games: 'Jeux recommandés',
      trending_games: 'Jeux tendances',
      featured_games: 'Jeux vedettes',
      popular_games: 'Jeux populaires',
      super_games: 'Super jeux',
      games_might_like: 'Jeux que vous pourriez aimer'
    },
    zh: {
      settings: '设置',
      ...
      notification_on: '通知已启用',
      notification_off: '通知已禁用',
      premium: '高级版',
      remove_ads: '移除广告',
      ...
      featured_apps: '精选应用',
      hot_right_now: '当下最火',
      top_pick_for_you: '为您优选',
      editors_picks: '编辑精选',
      popular_apps: '热门应用',
      new_experience: '全新体验',
      super_apps: '超级应用',
      apps_might_like: '您可能喜欢的应用',
      crowd_favorites: '大众最爱',
      this_month_best: '本月最佳',
      recommended_games: '推荐游戏',
      trending_games: '热门游戏',
      featured_games: '精选游戏',
      popular_games: '热门游戏',
      super_games: '超级游戏',
      games_might_like: '您可能喜欢的游戏'
    },
    de: {
      ...
      notification_on: 'Benachrichtigungen aktiviert',
      notification_off: 'Benachrichtigungen deaktiviert',
      premium: 'Premium',
      ...
      hot_right_now: 'Gerade angesagt',
      top_pick_for_you: 'Top-Tipp für dich',
      editors_picks: 'Empfehlungen der Redaktion',
      popular_apps: 'Beliebte Apps',
      new_experience: 'Neue Erfahrung',
      super_apps: 'Super-Apps',
      apps_might_like: 'Apps, die dir gefallen könnten',
      crowd_favorites: 'Publikumslieblinge',
      this_month_best: 'Das Beste dieses Monats',
      recommended_games: 'Empfohlene Spiele',
      trending_games: 'Beliebte Spiele',
      featured_games: 'Vorgestellte Spiele',
      popular_games: 'Beliebte Spiele',
      super_games: 'Super-Spiele',
      games_might_like: 'Spiele, die dir gefallen könnten'
    },
    ur: {
      settings: 'ترتیبات',
      ...
      share: 'شیئر کریں',
      share_game: 'گیم شیئر کریں',
      link_copied: 'لنک کاپی کر دیا گیا!',
      notification_on: 'اطلاعات آن ہو گئیں',
      notification_off: 'اطلاعات آف ہو گئیں',
      premium: 'پریمیئم',
      remove_ads: 'اشتہارات ہٹائیں',
      upgrade_to_premium: 'پریمیئم حاصل کریں',
      no_games_found: 'کوئی گیمز نہیں ملیں',
      loading_games: 'گیمز لوڈ ہو رہی ہیں...',
      open_in_app: 'ایپ میں کھولیں',
      games: 'گیمز',
      region: 'علاقہ',
      ...
      hot_right_now: 'ابھی کا گرم ترین',
      top_pick_for_you: 'آپ کے لیے ٹاپ انتخاب',
      editors_picks: 'ایڈیٹر کے انتخاب',
      popular_apps: 'مقبول ایپس',
      new_experience: 'نیا تجربہ',
      super_apps: 'سپر ایپس',
      apps_might_like: 'ایپس جو آپ کو پسند آ سکتی ہیں',
      crowd_favorites: 'لوگوں کے پسندیدہ',
      this_month_best: 'اس مہینے کا بہترین',
      recommended_games: 'تجویز کردہ گیمز',
      trending_games: 'ٹرینڈنگ گیمز',
      featured_games: 'نمایاں گیمز',
      popular_games: 'مقبول گیمز',
      super_games: 'سپر گیمز',
      games_might_like: 'گیمز جو آپ کو پسند آ سکتی ہیں'
    },
    hi: {
      settings: 'सेटिंग्स',
      ...
      hot_right_now: 'अभी सबसे लोकप्रिय',
      top_pick_for_you: 'आपके लिए शीर्ष चयन',
      editors_picks: 'संपादक की पसंद',
      popular_apps: 'लोकप्रिय ऐप्स',
      new_experience: 'नया अनुभव',
      super_apps: 'सुपर ऐप्स',
      apps_might_like: 'ऐप्स जो आपको पसंद आ सकते हैं',
      crowd_favorites: 'लोगों के पसंदीदा',
      this_month_best: 'इस महीने का सर्वश्रेष्ठ',
      recommended_games: 'अनुशंसित खेल',
      trending_games: 'ट्रेडिंग खेल',
      featured_games: 'विशेष खेल',
      popular_games: 'लोकप्रिय खेल',
      super_games: 'सुपर खेल',
      games_might_like: 'खेल जो आपको पसंद आ सकते हैं'
    },
    bn: {
      settings: 'সেটিংস',
      ...
      share: 'শেয়ার করুন',
      share_game: 'গেম শেয়ার করুন',
      link_copied: 'লিঙ্ক কপি করা হয়েছে!',
      notification_on: 'বিজ্ঞপ্তি চালু করা হয়েছে',
      notification_off: 'বিজ্ঞপ্তি বন্ধ করা হয়েছে',
      premium: 'প্রিমিয়াম',
      remove_ads: 'বিজ্ঞাপন সরান',
      upgrade_to_premium: 'প্রিমিয়ামে আপগ্রেড করুন',
      no_games_found: 'কোনো গেম পাওয়া যায়নি',
      loading_games: 'গেম লোড হচ্ছে...',
      open_in_app: 'অ্যাপে ওপেন করুন',
      games: 'গেম',
      region: 'অঞ্চল',
      ...
      hot_right_now: 'এই মুহূর্তে হট',
      top_pick_for_you: 'আপনার জন্য সেরা পছন্দ',
      editors_picks: 'সম্পাদকের পছন্দসমূহ',
      popular_apps: 'জনপ্রিয় অ্যাপস',
      new_experience: 'নতুন অভিজ্ঞতা',
      super_apps: 'সুপার অ্যাপস',
      apps_might_like: 'অ্যাপস যা আপনার ভালো লাগতে পারে',
      crowd_favorites: 'জনপ্রিয় পছন্দসমূহ',
      this_month_best: 'এই মাসের সেরা',
      recommended_games: 'প্রস্তাবিত গেম',
      trending_games: 'ট্রেন্ডিং গেম',
      featured_games: 'ফিচার্ড গেম',
      popular_games: 'জনপ্রিয় গেম',
      super_games: 'সুপার গেম',
      games_might_like: 'গেম যা আপনার ভালো লাগতে পারে'
    },
    ar: {
      settings: 'الإعدادات',
      ...
      notification_on: 'تم تشغيل الإشعارات',
      ...
      loading_games: 'جاري تحميل الألعاب...',
